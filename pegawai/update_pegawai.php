...
<?php
 if (isset($_GET['id'])){
        ...
        if ($_FILES['foto']['name']){
            ...
            $yu = mysqli_query($koneksi,"update pegawai set id_pegawai='$id_p',nama_pegawai='$nama',image='$gmbr',shift_kerja='$shift',password='$pass' where id_pegawai = '$id'");
        }else {        
            $yu = mysqli_query($koneksi,"update pegawai set id_pegawai='$id_p',nama_pegawai='$nama',shift_kerja='$shift',password='$pass' where id_pegawai = '$id'");
        }
    ...
    <div class="induk">
        ...
        <div class="konten-form">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="id-pegawai" id="" placeholder="Input ID Pegawai" class="form-input" value="<?= $data['id_pegawai'] ?>">

                <label>Nama Pegawai : </label><br>
                <input type="text" name="nama-pegawai" id="" placeholder="Input Nama Pegawai" class="form-input" value="<?= $data['nama_pegawai'] ?>">
