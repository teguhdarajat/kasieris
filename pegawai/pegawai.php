                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-aksi">
                                <a href="lihat_pegawai.php?id=<?= $data['id_pegawai'] ?>">Lihat</a>
                                <a href="update_pegawai.php?id=<?= $data['id_pegawai'] ?>">Ubah</a>
                                <a href="hapus_pegawai.php?id=<?= $data['id_pegawai'] ?>">Hapus</a>
                            </div>                            
                        </div>
                    </td>
                </tr>
