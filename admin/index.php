<?php
    include $_SERVER['DOCUMENT_ROOT']."/admin/cek_login.php"; 
    include "koneksi.php"; 
    ...
    $transaksi = 0;
    $pendapatan = 0;
    $query_pendapatan = mysqli_query($koneksi, "SELECT total FROM pembelian WHERE MONTH(tgl_pembelian) = MONTH(CURRENT_DATE())");
...
<!-- Awal Bagian Navigasi -->
    <nav>
        <ul>
            <li>
                <a href="/admin/index.php" class="aktif">
                    <i class="icon-home"></i>
                    <span>Home</span>
                </a>
            </li>
    ...
    <div class="induk">
        ...
        <div class="konten" style="background: #9cf196; overflow: visible; height: 170px">
            ...
            <h1 style="margin-top: 20px;font-size: 28pt;color: #0A9930; position: relative; left: 25px;">Selamat <?php echo $waktu.", ".strstr($_SESSION['login'], ' ', true); ?>!</h1>
            <br>
